          ...
          <div class="bnomics-altcoin-pane" ng-style="{'border-left': (altcoin_waiting)?'none':''}" ng-hide="show_altcoin != 1">
                ...
                <div class="bnomics-altcoin-waiting" ng-show="altcoin_waiting" ng-init=
            	  ...
            	  <!-- Alt status CANCELED -->
	                ...
	                <p><?=__('This probably happened because you paid less than the expected amount.<br>Please contact <a href="mailto:hello@flyp.me">hello@flyp.me</a> with below order id for refund:', 'blockonomics-bitcoin-payments')?></p>
            	  </div>
            	  <!-- Alt status EXPIRED -->
              	  <div class="bnomics-status-flex bnomics-altcoin-bg-color" ng-show="order.altstatus == -3" ng-cloak >
              	  	<h4>Expired</h4>
