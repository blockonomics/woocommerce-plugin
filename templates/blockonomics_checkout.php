                    ...
                    <div class="bnomics-btc-info">
                        ...
                        <div class="bnomics-amount">
                            <div class="bnomics-bg">
                                <!-- Order Amounts -->
                                <div class="bnomics-amount">
                                    <div class="bnomics-amount-text"><?=__('1. Buy Bitcoin <a href="#">here</a><br>2. Send the <strong>BTC</strong> to the given address<br>3. Wait for payment confirmation', 'blockonomics-bitcoin-payments')?></div>
